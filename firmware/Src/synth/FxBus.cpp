...
void FxBus::processBlock(int32_t *outBuff) {
	...
	for (int s = 0; s < BLOCK_SIZE; s++) {
		...
		dcBlock2b = ap4In;
		dcBlock5a = dcBlock2a - dcBlock5b + dcBlockerCoef * dcBlock5a;			// dc blocker
		dcBlock5b = dcBlock2a;
