...
public:
    ...
    void updateAllMixOscsAndPans() {
        ...
        // add a LP on mix when MPE to mitigate noise dur to midi CC being [0-127]
        bool notMPE = currentTimbre->timbreNumber_ != 0 || currentTimbre->getMPESetting() == 0;
