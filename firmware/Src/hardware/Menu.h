...
enum {
    ...
    MIDICONFIG_TFT_AUTO_REINIT,
    MIDICONFIG_ENCODER_PUSH,
    MIDICONFIG_TFT_BACKLIGHT,
    MIDICONFIG_SIZE
};
...
enum MASTERFXPARAMS {
    ...
    GLOBALFX_INPUTDIFFUSION,
    GLOBALFX_DECAYDIFFUSION,
    GLOBALFX_DAMPING,
    GLOBALFX_LFODEPTH,
    GLOBALFX_LFOSPEED,
    GLOBALFX_ENVMOD,
    GLOBALFX_TREMOLOENVFOLLOW,
    GLOBALFX_TREMOLOSPEED,
    GLOBALFX_TREMOLODEPTH,
