...
public:
    ...
    void oscilloBgSetLfo(float shape, float freq, float kSyn, float syncMode, float bias, float phase);
    void oscilloBgSetOperatorPhase(float phaseDegrees, float warp);
